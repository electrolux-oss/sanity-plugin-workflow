...
function useWorkflowDocuments(schemaTypes, filterOptions) {
  ...
  const QUERY = groq__default.default(_a$2 || (_a$2 = __template$2(['*[_type == "workflow.metadata" && (!defined($localeFilter) || count($localeFilter) == 0 || locale in $localeFilter)]|order(orderRank){\n    "_metadata": {\n      _rev,\n      assignees,\n      documentId,\n      state,\n      orderRank,\n      "draftDocumentId": "drafts." + documentId,\n    }\n  }{\n    ...,\n    ...(\n      *[_id == ^._metadata.documentId || _id == ^._metadata.draftDocumentId]|order(_updatedAt)[0]{ \n        _id, \n        _type, \n        _rev, \n        _updatedAt \n      }\n    )\n  }'])));
  const {
    data,
    loading,
    error
...
function Filters(props) {
  ...
  const memoizedCurrentUser = sanity.useCurrentUser();
  const currentUser = React.useMemo(() => memoizedCurrentUser, [memoizedCurrentUser]);
  const schema = sanity.useSchema();
  const onAddUserToFilter = React.useCallback(id => {
    if (!selectedUserIds.includes(id)) {
      toggleSelectedUser(id);
    }
  }, [selectedUserIds, toggleSelectedUser]);
  const onRemoveUserFromFilter = React.useCallback(id => {
    if (selectedUserIds.includes(id)) {
      toggleSelectedUser(id);
    }
  }, [selectedUserIds, toggleSelectedUser]);
  const onClearUserFilter = React.useCallback(() => {
    resetSelectedUsers();
  }, [resetSelectedUsers]);
  ...
  const UserFilter = () => /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
    tone: "default",
  ...
  const SlimUserFilter = () => /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
    tone: "inherit",
    children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
      gap: 2,
      ...
      }), uniqueAssigneesNotMe.map(user => /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
        padding: 0,
  ...
  const LocaleFilter = () => /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
    tone: "default",
    children: /* @__PURE__ */jsxRuntime.jsx(ui.MenuButton, {
      button: /* @__PURE__ */jsxRuntime.jsx(ui.Button, {
        padding: 3,
      ...
      menu: /* @__PURE__ */jsxRuntime.jsxs(ui.Menu, {
        ...
        children: [/* @__PURE__ */jsxRuntime.jsx(ui.MenuItem, {
          ...
          return /* @__PURE__ */jsxRuntime.jsx(ui.MenuItem, {
            ...
            icon: selected ? /* @__PURE__ */jsxRuntime.jsx(icons.CheckmarkCircleIcon, {
              style: {
  ...
  return /* @__PURE__ */jsxRuntime.jsx(ui.Card, {
    ...
    children: /* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
      ...
      children: [/* @__PURE__ */jsxRuntime.jsxs(ui.Flex, {
        ...
        gap: 4,
        flex: 1,
        children: [shouldDisplayUserFilter && /* @__PURE__ */jsxRuntime.jsx(UserFilter, {}), !shouldDisplayUserFilter && /* @__PURE__ */jsxRuntime.jsx(SlimUserFilter, {}), userLocales && /* @__PURE__ */jsxRuntime.jsx(LocaleFilter, {})]
...
function WorkflowTool(props) {
  ...
  const isDarkMode = React.useMemo(() => theme.sanity.color.dark, [theme]);
  ...
  const filterOptions = React.useMemo(() => filters == null ? void 0 : filters(user), [filters, user]);
  ...
  const toggleLocales = React.useCallback(locales => {
              ...
              children: [/* @__PURE__ */jsxRuntime.jsx(StateTitle, {
                ...
                children: /* @__PURE__ */jsxRuntime.jsx(dnd.Droppable, {
                  ...
                  children: (provided, snapshot) => /* @__PURE__ */jsxRuntime.jsxs(ui.Card, {
                    ...
                    children: [loading && /* @__PURE__ */jsxRuntime.jsx(ui.Flex, {
                    ...
                    }), !loading && selectedLocales.length === 0 && /* @__PURE__ */jsxRuntime.jsx(ui.Flex, {
                      align: "center",
                      justify: "center",
                      height: "fill",
                      padding: 6,
                      children: /* @__PURE__ */jsxRuntime.jsxs(ui.Text, {
                        size: 3,
                        align: "center",
                        children: ["No documents found.", /* @__PURE__ */jsxRuntime.jsx("br", {}), " Have you selected a language in the filter?"]
                      })
                    }), selectedLocales.length > 0 && /* @__PURE__ */jsxRuntime.jsx(DocumentList, {
                      data,
                      invalidDocumentIds,
                      patchingIds,
                      selectedSchemaTypes,
